...
const TicTacToe = () => {
  ...
  useEffect(() => {
    ...
    else if (array[4] === "O" && array[3] === "" && array[5] === "")
      newArray[3] = "O";
    else if (array[4] === "O" && array[1] === "" && array[7] === "")
      newArray[1] = "O";
    else if (
      array[4] === "O" &&
      array[1] === "X" &&
    ...
    <>
      <div className="game-container flex flex-col justify-center items-center">
        <div className="turn">
          ...
          >
            <h1 className="font-semibold">Your Turn (X) : {xWon}</h1>
          </div>
          <div
            className={`my-turn ${
          ...
          >
            <h1 className="font-semibold">My Turn (O) : {oWon}</h1>
          </div>
        </div>
        <div className="game grid grid-cols-3">
          <div className="col border-b-8 border-r-8 border-[#0da192]">
            <button
          ...
          <div className="col border-b-8 border-[#0da192]">
            <button
          ...
          <div className="col border-r-8 border-[#0da192]">
            <button
